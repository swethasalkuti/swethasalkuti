...
--Comparing total cases and total deaths to show likelihood of dying if infected with covid in USA
...
--Number of vaccinations given to people in each location on daily basis
...
--Global numbers
--Newcases, newdeaths and totalvaccines per day across the world
